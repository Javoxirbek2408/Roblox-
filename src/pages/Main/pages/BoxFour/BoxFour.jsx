    ...
    return (
        <div className='mb-5 mt-5 '>
            <div  style={{ position: 'relative', overflow: 'hidden' }}>
                ...
                <iframe src="https://yandex.uz/map-widget/v1/?ll=69.279737%2C41.311151&z=12" className='lg:w-full lg:h-[594px] w-[430px] h-[487px]' frameBorder={1} allowFullScreen="true" style={{ position: 'relative' }} /></div>
        </div>
    )
}
