...
export const BoxThere = () => {
    return (
      <div>
        ...
        >
          <input
            className="w-[400px] pl-4 text-[ #00000066] h-[62px] bg-white  outline-0"
            type="text"
          ...
          <Button
            type="submit"
            className={
              "w-[400px] btnShadow h-[62px] bg-[#FFE000] font-bold text-2xl leading-[100%] tracking-[0%] uppercase text-black"
            }
          >
            получить
          </Button>
        ...
        <div className="flex items-center justify-center gap-4 mt-5">
          <Button className="bg-[#FFE000] btnShadow text-black font-bold text-2xl leading-[100%] tracking-[0%] uppercase w-[200px] h-[62px]">
            Филиал Ц4
          </Button>
          <Button className="bg-white text-black font-bold text-base leading-[100%] tracking-[0%] uppercase w-[200px] h-[62px]">
             Филиал Беруни
          </Button>
        </div>
        <div className="flex items-center  justify-between p-4 gap-4 mt-5">
          <NavLink className={"flex items-center gap-2"}>
            ...
            <p className=" font-normal text-[10px] leading-[100%] font-invole text-white">
              Орьентир
            </p>
          </NavLink>
          <NavLink className={"flex items-center gap-2"}>
            <img src={locotion} alt="" />{" "}
            <p className=" font-normal text-[10px] leading-[100%] font-invole text-white">
              Орьентир
            </p>
          </NavLink>
